...
| Shopify profile | CDS-SHOPIFY-0.2 (platform profile release, statements verified 2026-08-03/04; versioned separately from the corpus release CDS v0.3 — CDS-900 §1) |
| Industry profiles | `cds.profile.apparel.v0_3`, `cds.profile.homewares.v0_3` (add any others claimed from the CDS-1500 §2.1 register, for example `cds.profile.footwear.v0_3` or `cds.profile.beauty_health.v0_3`; an extension profile requires its parent) |
