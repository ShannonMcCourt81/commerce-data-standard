...
**Industry Profile** — A named, versioned set of product-family and category rules, attribute baselines and dictionary bindings that refines the CDS core for a commerce vertical; listed in the Industry Profile Register. *Home: CDS-1500 §2 (the Industry Profile Framework); the profiles themselves in CDS-1500 through CDS-2000.*
...
**Product Relationship** — A governed, directed or symmetric, typed link from a Product or Variant to another product, model family, standard, application or external part, carried in the product's `relationships` collection with provenance and lifecycle. *Home: CDS-200 §7A.*
...
**Kit** — A Product whose sellable content is composed of other Products through `includes` relationships; stocked kits, virtual bundles and assemblies are its declared kinds. *Home: CDS-200 §7A.2.*
