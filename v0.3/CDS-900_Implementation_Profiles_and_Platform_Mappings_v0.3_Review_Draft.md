...
| Date | 2026-08-17 (platform profile content and verification); 2026-09-20 for the corpus v0.3 notes in §1 and §9A |
...
**Profile releases defined by this chapter:** CDS-SHOPIFY-0.2 (§4), CDS-GMC-0.2 (§5), CDS-META-0.2 (§6). A platform profile's release number is bound to the verification of its platform statements, not to the corpus release: it advances only when those statements are re-verified (ADR-D7, owner decision IP10), so it can lag the corpus release and is always shown beside it wherever a profile version or freshness date appears.

| Version shown | Value | Meaning |
|---|---|---|
| Corpus release | CDS v0.3 (2026-09-20) | The release of the standard this chapter belongs to |
| Platform profile releases | CDS-SHOPIFY-0.2, CDS-GMC-0.2, CDS-META-0.2 | Carried forward unchanged from CDS v0.2; no platform statement was re-verified for v0.3 |
| Platform statement freshness | Retrieved and spot-verified 2026-08-03/04, with Shopify Search & Discovery filter behaviour re-verified 2026-08-17 (REVIEW-006, REVIEW-006A) | The dates that govern R002; re-verify against the current platform documentation before relying on a statement in a later release |
...
## 4. Shopify Implementation Profile — CDS-SHOPIFY-0.2 *(normative rules; platform statements informative, references retrieved 2026-08-03; platform profile release 0.2 within corpus release v0.3 — see §1)*
...
## 5. Google Merchant Center Profile — CDS-GMC-0.2 *(normative rules; mapping table informative, references retrieved 2026-08-03; platform profile release 0.2 within corpus release v0.3 — see §1)*
...
## 6. Meta Catalogue Profile — CDS-META-0.2 *(normative rules; platform statements informative, references retrieved 2026-08-03; platform profile release 0.2 within corpus release v0.3 — see §1)*
...
END OF CDS-900 v0.3 REVIEW DRAFT
