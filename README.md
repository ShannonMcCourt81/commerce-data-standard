...
- **Done:** the v0.2 standard (1,320 requirements after the 2026-09-20 industry-profile expansion; the original 1,034 internally reviewed, the 286 new ones awaiting the owner's IP1–IP9 dispositions and external review), the executable reference package (33/33 clean), the restructured dictionary data, and the setup runbook — all adversarially verified.
